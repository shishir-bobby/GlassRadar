...
@property (nonatomic, strong, readwrite) UIView *hudView;
...
//        if ([string rangeOfString:@"Please Wait..."].location != NSNotFound || [string rangeOfString:@"Location"].location != NSNotFound)
        if ([[string uppercaseString] isEqualToString:@"PLEASE WAIT..."])
            
        {
            ...
            labelRect = CGRectMake(5, 55, 120, 80);
    ...
    if(string)
        self.imageView.center = CGPointMake(CGRectGetWidth(self.hudView.bounds)/2, 30);
	else
