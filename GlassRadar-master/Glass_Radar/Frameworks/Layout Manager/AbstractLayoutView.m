...
@synthesize spacing;
@synthesize leftMargin, rightMargin;
...
{
    self = [self initWithFrame:frame spacing:s leftMargin:lm rightMargin:rm topMargin:tm bottomMargin:bm];
    fullScreen = flagScreen;
    return self;
}  
- (id)initWithFrame:(CGRect)frame spacing:(int)s leftMargin:(int)lm
    rightMargin:(int)rm topMargin:(int)tm bottomMargin:(int)bm
